...
import { VANS_CONVERSE } from '../../redux/Type/Type'
...
export default function Adidas() {
    ...
    useEffect(() => {
        dispatch(getProductByCategoryAction(VANS_CONVERSE))
    ...
    return (
        <div style={{ minHeight: "100vh" }}>
            <div style={{ backgroundColor: "#f1f2f4" }}>
                <h1 className='text-center py-5'>VANS CONVERSE</h1>
            </div>
